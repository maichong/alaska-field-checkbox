...
var Checkbox = function (_React$Component) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      var checked = props.value ? 'checked' : undefined;
      var type = props.radio ? 'radio' : 'checkbox';
      return _react2.default.createElement(
        'label',
        { className: type, style: props.style },
        _react2.default.createElement('input', { type: type, checked: checked, className: 'custom-' + type, onChange: this.handleCheck }),
